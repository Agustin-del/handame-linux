...
-Wno-unused-variable -Wno-unused-but-set-variable -Wno-c++20-designator
...
DEV_LINKER_FLAGS="-lxcb -Wl,--gc-sections"

clang++ $DEV_COMPILER_FLAGS -o build/handmade code/linux32-handmade.cpp $DEV_LINKER_FLAGS
